      ...
      >
        <div className="card p-8 md:p-10">
          <div className="text-center mb-8">
            ...
            <h1 className="font-display text-3xl font-bold text-chocolate-800">Create Account</h1>
            <p className="text-sm text-chocolate-400 mt-2">Join Jesmer and start designing cakes</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-sm font-medium text-chocolate-700 mb-1.5">Full Name</label>
              <input
                type="text"
                value={name}
          ...
          <p className="text-center text-sm text-chocolate-400 mt-6">
            ...
            <Link to="/login" className="text-rose-500 font-semibold hover:text-rose-600">Log in</Link>
          </p>
        </div>
      </motion.div>
    </div>
